...
[geoparsepy_preprocessed_tables.tar.zip](https://www.southampton.ac.uk/~sem03/geoparsepy/geoparsepy_preprocessed_tables.tar.zip) 1.6 GB tar/zip file of pg_dump SQL output created using 7Zip
